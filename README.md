...
| **WhitePaper** | [English](docs/WHITEPAPER_EN.md) / [日本語](shikiben-v2.5/docs/Shikiben_V2.5.0_Whitepaper.md) | Background challenges, conceptual synthesis of philosophy and mechanics, and application use cases. |
