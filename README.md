...
| **WhitePaper** | [English](docs/WHITEPAPER_EN.md) / [日本語](shikiben-v2.5.0/docs/whitepaper_v2_5.md) | Background challenges, conceptual synthesis of philosophy and mechanics, and application use cases. |
