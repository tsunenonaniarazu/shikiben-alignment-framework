# Refining script to ensure smooth plots and precise visualization
import numpy as np
...
for i in range(1, t_steps):
    ...
    # Shikiben V2.5.0 system: P_gi cuts x2 ego distortion, smoothly settles to origin
...
print("Simulation visual successfully rendered and saved.")